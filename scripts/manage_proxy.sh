...
install(){    
    ...
    wget https://cdn.jsdelivr.net/gh/GoMinerProxy/GoMinerProxy@main/release/GoMinerProxy_v1.1.0_linux_amd64.tar.gz -O /root/GoMinerProxy_v1.1.0_linux_amd64.tar.gz
